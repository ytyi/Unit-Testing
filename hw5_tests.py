...
class TestCard(unittest.TestCase):
    ...
    def test_q1(self):
        ...
        '''
        card=hw.Card(rank=12)
        return self.assertEqual(card.rank_name,"Queen")
    ...
    def test_q2(self):
        ...
        '''
        card = hw.Card(suit=1)
        return self.assertEqual(card.suit_name, "Clubs")
    ...
    def test_q3(self):
        ...
        '''
        card = hw.Card(suit=3,rank=13)
        return self.assertEqual(card.__str__(), "King of Spades")
    ...
    def test_q4(self):
        ...
        '''
        deck=hw.Deck()
        return self.assertEqual(len(deck.cards),52)
    ...
    def test_q5(self):
        ...
        '''
        deck=hw.Deck()
        return self.assertIsInstance(deck.deal_card(),hw.Card)
    ...
    def test_q6(self):
        ...
        deck = hw.Deck()
        deck.deal_card()
        return self.assertEqual(len(deck.cards), 51)
